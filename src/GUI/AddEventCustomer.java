 ...
 * @author DELL
 */
public class AddEventCustomer extends javax.swing.JDialog {

    /**
     * Creates new form AddEventCustomer
     */
    public AddEventCustomer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddEventCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddEventCustomer dialog = new AddEventCustomer(new javax.swing.JFrame(), true);
